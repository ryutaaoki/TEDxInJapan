(function() {
  ...
  Joshfire.factory = {
    ...
    config: {"app":{"id":"5179009abb693502000000a6","icon":null,"logo":null,"name":"tedxenfrance","version":"1.0"},"template":{"name":"tedxregionallens","version":"0.0.7","options":{"idwidget":"327755683451764736","language":"fr","ganalytics":"UA-40903246-1","url":"http://www.gdfsuez.com/"},"hooks":[]}},
    device: {},
    addons: {}
  };
  Joshfire.factory.config.deploy = {"env":"dev","type":"preview","flags":{"web":true},"id":""};
  Joshfire.factory.config.datasources = {"about":{"name":"AboutPage","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"AboutPage","db":"google","col":"spreadsheets","query":{"filter":{"usestdmapping":true,"sheetid":3,"docid":"https://docs.google.com/spreadsheet/pub?key=0AnfI0Uxy0S8YdHIxZGRHbzFDY04tZ24zRGtOUjgtbHc"}},"runatclient":true,"missingKeys":[],"outputType":"Article","runtime":"browser"}},"action":"addtarget"}},"outputType":"Article","runatclient":true,"runtime":"browser"},"blacklist":{"name":"Blacklist","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"Blacklist","db":"google","col":"spreadsheets","query":{"filter":{"docid":"https://docs.google.com/spreadsheet/pub?key=0AnfI0Uxy0S8YdHIxZGRHbzFDY04tZ24zRGtOUjgtbHc","sheetid":2,"usestdmapping":true},"options":{}},"runatclient":true,"missingKeys":[],"outputType":"Article","runtime":"browser"}},"action":"addtarget"}},"outputType":"Article","runatclient":true,"runtime":"browser"},"tedxevents":{"name":"TEDxEvents","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"TEDxEvents","db":"google","col":"spreadsheets","query":{"filter":{"docid":"https://docs.google.com/spreadsheet/pub?key=0AnfI0Uxy0S8YdHIxZGRHbzFDY04tZ24zRGtOUjgtbHc","sheetid":1,"usestdmapping":true},"options":{}},"runatclient":true,"missingKeys":[],"outputType":"Article","runtime":"browser"}},"action":"addtarget"}},"outputType":"Article","runatclient":true,"runtime":"browser"},"youtube":{"name":"Youtube","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"Youtube","db":"youtube","col":"videos","query":{"filter":{"playlist":"http://www.youtube.com/playlist?list=PLcUNmiDleGGPWyZf1tri28SvisiPgKXWR"},"options":{}},"runatclient":true,"missingKeys":[],"outputType":"VideoObject","runtime":"browser"}},"action":"addtarget"}},"outputType":"VideoObject","runatclient":true,"runtime":"browser"},"tweets":{"name":"Twitter","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"Twitter","id":"tmp_51891218c75207020000005b","db":"twitter","col":"tweets","outputType":"Article/Status","runatclient":false,"runtime":"hosted","apikey":"/e3HiVc6uIbdwZmV4lYeRnScLJZvgvQsBgXPzMrhCQDxYVdREAwSXBD66xAbAmKb"}},"action":"addtarget"}},"outputType":"Article/Status","runatclient":true,"runtime":"browser"},"rssyoutube":{"name":"Youtube Grab","db":"operator","col":"updatelinks","query":{"filter":{"datasources":{"main":{"name":"Youtube Grab","db":"youtube","col":"videos","query":{"filter":{"playlist":"http://www.youtube.com/playlist?list=PLSKUhDnoJjYkpAsfly8rN_hk6jTWfffyr"}},"runatclient":true,"missingKeys":[],"outputType":"VideoObject","runtime":"browser"}},"action":"addtarget"}},"outputType":"VideoObject","runatclient":true,"runtime":"browser"}};
    ...
    self.find = function (options, callback) {
      self.onLoaded(function () {
        ...
        if (cacheKeyObject.query.nocache) {
          ...
          // "options" object since we're working on a shallow clone of it)
      ...
      "options": {
        "schema": {
          ...
          "usestdmapping": {
            ...
            "description": "Spreadsheet uses standard column headers, which match schema.org properties (as illustrated in <a href='https://docs.google.com/spreadsheet/ccc?key=0As_8C1ajtYj-dDZhSDNEczJWSmp5UVE1d0RnRVVhQmc'>standard example</a>)",
            "default": false
          }
        },
        "form": [
